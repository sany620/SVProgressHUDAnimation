...
@interface CustomSVLoadingAnimatedView:SVIndefiniteAnimatedView

- (instancetype)initWithType:(FDLoadingAnimationType)type tintColor:(UIColor* __nonnull)color;
@property (nonatomic)CALayer *indefiniteAnimatedLayer;
@property (nonatomic)UIColor* tintColor;
@property (nonatomic, assign)FDLoadingAnimationType indicatorAnimationType;
@end
...
+ (void)svShowLoding{
    ...
    [self setActivityIndicatorType:FDLoadingAnimationTypeBallClipRotatePulse];
    [self setActivityIndicatorTintColor:UIColor.blueColor];
    [self show];
}
+ (void)unsetActivityIndicator{
    ...
    [self removeAnimatedViewWithSpecifiedClass:[CustomSVLoadingAnimatedView class]];
...
+ (void)removeAnimatedViewWithSpecifiedClass:(Class __nonnull)viewClass{
    ...
    UIVisualEffectView* hudVibrancyView = [hud valueForKey:@"_hudView"];
    if (hudVibrancyView) {
...
+ (void)setActivityIndicatorType:(FDLoadingAnimationType)type{
    ...
    CustomSVLoadingAnimatedView* view = [[CustomSVLoadingAnimatedView alloc] initWithType:type tintColor:tintColor];
...
@implementation CustomSVLoadingAnimatedView
...
- (CALayer*)generateActivityIndicatorLayer{
    ...
    switch (self.indicatorAnimationType) {
        case FDLoadingAnimationTypeNineDots:{
        ...
        case FDLoadingAnimationTypeTriplePulse:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeFiveDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeRotatingSquares:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeDoubleBounce:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeTwoDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeThreeDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeBallPulse:{
        ...
        case FDLoadingAnimationTypeBallClipRotate:{
            CGFloat duration = 0.75f;
        ...
        case FDLoadingAnimationTypeBallClipRotatePulse:{
        ...
        case FDLoadingAnimationTypeBallClipRotateMultiple:{
        ...
        case FDLoadingAnimationTypeBallRotate:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeBallZigZag:{
        ...
        case FDLoadingAnimationTypeBallZigZagDeflect:{
            CGFloat duration = 0.75f;
            CGFloat circleSize = size.width / 5;
            CGFloat deltaX = size.width / 2 - circleSize / 2;
            CGFloat deltaY = size.height / 2 - circleSize / 2;
        ...
        case FDLoadingAnimationTypeBallTrianglePath:{
        ...
        case FDLoadingAnimationTypeBallScale:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeLineScale:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeLineScaleParty:{
        ...
        case FDLoadingAnimationTypeBallScaleMultiple:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeBallPulseSync:{
        ...
        case FDLoadingAnimationTypeBallBeat:{
            CGFloat duration = 0.7f;
        ...
        case FDLoadingAnimationTypeLineScalePulseOut:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeLineScalePulseOutRapid:{
        ...
        case FDLoadingAnimationTypeBallScaleRipple:{
            CGFloat duration = 1.0f;
        ...
        case FDLoadingAnimationTypeBallScaleRippleMultiple:{
        ...
        case FDLoadingAnimationTypeTriangleSkewSpin:{
        ...
        case FDLoadingAnimationTypeBallGridBeat:{
        ...
        case FDLoadingAnimationTypeBallGridPulse:{
        ...
        case FDLoadingAnimationTypeRotatingSandglass:{
        ...
        case FDLoadingAnimationTypeRotatingTrigons:{
        ...
        case FDLoadingAnimationTypeTripleRings:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case FDLoadingAnimationTypeCookieTerminator:{
            NSTimeInterval beginTime = CACurrentMediaTime();
